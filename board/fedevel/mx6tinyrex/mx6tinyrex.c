...
static const iomux_v3_cfg_t rgb_pads[] = {
	IOMUX_PAD_CTRL(CSI0_PIXCLK__IPU1_CSI0_PIXCLK, RGB_PAD_CTRL),
	IOMUX_PAD_CTRL(CSI0_DATA_EN__IPU1_CSI0_DATA_EN, RGB_PAD_CTRL),	/* DRDY */
	IOMUX_PAD_CTRL(CSI0_MCLK__IPU1_CSI0_HSYNC, RGB_PAD_CTRL),		/* HSYNC */
	IOMUX_PAD_CTRL(CSI0_VSYNC__IPU1_CSI0_VSYNC, RGB_PAD_CTRL),		/* VSYNC */
