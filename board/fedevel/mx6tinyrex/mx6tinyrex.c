...
static const iomux_v3_cfg_t rgb_pads[] = {
	...
	IOMUX_PAD_CTRL(EIM_D29__IPU1_DI1_PIN15, RGB_PAD_CTRL),	/* DRDY */
	IOMUX_PAD_CTRL(EIM_D23__IPU1_DI1_PIN02, RGB_PAD_CTRL),		/* HSYNC */
	IOMUX_PAD_CTRL(EIM_EB3__IPU1_DI1_PIN03, RGB_PAD_CTRL),		/* VSYNC */
