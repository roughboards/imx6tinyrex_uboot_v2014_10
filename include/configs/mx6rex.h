...
#define CONFIG_ENV_DEFAULT_UBT_FILE	"u-boot-" CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex.imx"
#define CONFIG_ENV_DEFAULT_IMG_FILE	"zImage-" CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex"
#define CONFIG_ENV_DEFAULT_FDT_FILE	CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex.dtb"
#define CONFIG_ENV_DEFAULT_SCR_FILE	"boot-"   CONFIG_REX_DEFAULT_ARCH_PREFIX "-rex.scr"
